...
class TCS34725(object):
    ...
    def __init__(self, i2c, addr=TCS34725_I2C_ADDR):
        ...
        if self.__id not in TCS3472x_dict.keys():  # check for supported device
    ...
    def autogain(self, autogain_new):
        ...
        self.__autogain = True if autogain_new else False
